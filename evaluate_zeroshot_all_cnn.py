"""
Zero-shot cross-dataset evaluation for all CNN ablation models (ab1–ab7).

Evaluates each ablation model directly on ayuraj and danrasband —
no fine-tuning, weights as trained on ASL39.

Usage:
    python evaluate_zeroshot_all_cnn.py
"""
import csv
import sys
...
MODELS = [
    ("ab1", HERE / "cnn_classifier/models/best_cnn_classifier_asl39_ab1_baseline.pth",  "standard"),
    ("ab2", HERE / "cnn_classifier/models/best_cnn_classifier_asl39_ab2_adamw.pth",     "standard"),
    ("ab3", HERE / "cnn_classifier/models/best_cnn_classifier_asl39_ab3_aug.pth",       "standard"),
    ("ab4", HERE / "cnn_classifier/models/best_cnn_classifier_asl39_ab4_aug_ls.pth",    "standard"),
...
def main():
    ...
    summary_path = OUT_DIR / "zeroshot_all_cnn_summary.csv"
