...
# load data
latents = np.load("learningrate/test_latent_vectors.npy")
labels  = np.load("learningrate/test_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (LR = 5e-4) - Test Set")

plt.savefig("tsne_lr5e-4_test.png", dpi=300)
plt.show()