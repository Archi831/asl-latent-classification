...
# load data
latents = np.load("main/test_latent_vectors.npy")
labels  = np.load("main/test_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ASL29) - Test Set")

plt.savefig("tsne_main_test.png", dpi=300)
plt.show()
