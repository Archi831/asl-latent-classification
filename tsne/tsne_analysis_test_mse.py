...
# load data
latents = np.load("MSE/test_latent_vectors.npy")
labels  = np.load("MSE/test_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ONLY MSE) - Test Set")

plt.savefig("tsne_MSE_test.png", dpi=300)
plt.show()