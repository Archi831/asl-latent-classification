...
# load data
latents = np.load("SSIM/test_latent_vectors.npy")
labels  = np.load("SSIM/test_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ONLY SSIM) - Test Set")

plt.savefig("tsne_SSIM_test.png", dpi=300)
plt.show()