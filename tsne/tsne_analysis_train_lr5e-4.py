...
# load data
latents = np.load("learningrate/train_latent_vectors.npy")
labels  = np.load("learningrate/train_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (LR = 5e-4) - Train Set")

plt.savefig("tsne_lr5e-4_train.png", dpi=300)
plt.show()