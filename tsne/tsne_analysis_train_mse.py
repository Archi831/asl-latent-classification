...
# load data
latents = np.load("MSE/train_latent_vectors.npy")
labels  = np.load("MSE/train_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ONLY MSE) - Train Set")

plt.savefig("tsne_MSE_train.png", dpi=300)
plt.show()
