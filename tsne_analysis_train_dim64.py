...
# load data
latents = np.load("latentspace64/train_latent_vectors.npy")
labels  = np.load("latentspace64/train_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (Dim = 64) - Train Set")

plt.savefig("tsne_dim64_train.png", dpi=300)
plt.show()