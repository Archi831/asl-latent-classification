...
# load data
latents = np.load("main/train_latent_vectors.npy")
labels  = np.load("main/train_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ASL29) - Train Set")

plt.savefig("tsne_main_train.png", dpi=300)
plt.show()
