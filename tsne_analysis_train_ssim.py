...
# load data
latents = np.load("SSIM/train_latent_vectors.npy")
labels  = np.load("SSIM/train_latent_labels.npy")
...
plt.title("t-SNE of Latent Space (ONLY SSIM) - Train Set")

plt.savefig("tsne_SSIM_train.png", dpi=300)
plt.show()